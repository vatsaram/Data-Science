...
ggplot(loans_charged_off, aes(x = term, fill = "red")) + geom_bar() +
...
ggplot(loans_charged_off, aes(x = home_ownership)) + geom_bar() +
  geom_text(stat = "count", aes(label = ..count.., vjust = -0.1)) + 
...
ggplot(loans_charged_off, aes(x = purpose)) + geom_bar() +
  geom_text(stat = "count", aes(label = ..count.., vjust = -0.1)) + 
...
ggplot(loan_data, aes(x = purpose)) + geom_bar() +
  geom_text(stat = "count", aes(label = ..count.., vjust = -0.1)) + 
...
ggplot(loans_charged_off, aes(x = verification_status)) + geom_bar() +
  geom_text(stat = "count", aes(label = ..count.., vjust = -0.1)) + 
...
ggplot(loans_charged_off, aes(x = grade)) + geom_bar() +
  geom_text(stat = "count", aes(label = ..count.., vjust = -0.1)) + 
